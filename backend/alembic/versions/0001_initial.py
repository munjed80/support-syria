...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("category", postgresql.ENUM(name="request_category", create_type=False), nullable=False),
        sa.Column("priority", postgresql.ENUM(name="priority_level", create_type=False), nullable=False, server_default="normal"),
        sa.Column("status", postgresql.ENUM(name="request_status", create_type=False), nullable=False, server_default="submitted"),
        ...
        sa.Column("sla_status", postgresql.ENUM(name="sla_status", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("from_status", postgresql.ENUM(name="request_status", create_type=False), nullable=True),
        sa.Column("to_status", postgresql.ENUM(name="request_status", create_type=False), nullable=True),
        sa.Column("from_priority", postgresql.ENUM(name="priority_level", create_type=False), nullable=True),
        sa.Column("to_priority", postgresql.ENUM(name="priority_level", create_type=False), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("request_id", postgresql.UUID(as_uuid=True),
                  sa.ForeignKey("service_requests.id"), nullable=False),
        sa.Column("kind", postgresql.ENUM(name="attachment_kind", create_type=False), nullable=False, server_default="photo"),
